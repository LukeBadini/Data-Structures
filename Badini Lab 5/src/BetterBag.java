...
public class BetterBag {
	...
	/**
	 * Add a new element to this bag. If the new element would take 
		this
 ...
 (i.e., the
	...
	/**
	 * Return status of this bag as a String.  For example, 
		if a bag of 
	...
	public int removeRandom() {
		int randomElement = this.getRandom();
	...
	public boolean contains(int target) {
		return (this.countOccurrences(target) > 0);
	}
	...
	public boolean equals(BetterBag otherBag) {
    	...
    	else
    	{
    		while (!clone.isEmpty())
    		{
    			int temp = clone.removeRandom();
    			if (this.countOccurrences(temp) != 
    					otherBag.countOccurrences(temp))
    			{
    				return false;
    			}
    		}
